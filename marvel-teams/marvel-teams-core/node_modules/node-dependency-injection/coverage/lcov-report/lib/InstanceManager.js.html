...
<html lang="en">
<head>
    <title>Code coverage report for lib/InstanceManager.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">All files</a> / <a href="index.html">lib</a> InstanceManager.js
    </h1>
    <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import Reference from './Reference'
...
import NotAbstractServiceException
  from './Exception/NotAbstractServiceException'
import MethodCallNotFoundException
  from './Exception/MethodCallNotFoundException'
...
&nbsp;
   ...
   * @private
   */
  _getInstanceFromId (id, bypassPublic = <span class="branch-0 cbranch-no" title="branch not covered" >false)</span> {
...
&nbsp;
   ...
   * @private
   */
  _getExistingInstanceFromId (id, bypassPublic = <span class="branch-0 cbranch-no" title="branch not covered" >false)</span> {
    const definition = this._definitions.get(id)
&nbsp;
...
&nbsp;
   ...
   * @private
   */
  _resolveArguments (args = <span class="branch-0 cbranch-no" title="branch not covered" >[])</span> {
...
&nbsp;
   ...
   * @private
   */
  _appendParentArgumentsFromDefinition (definition, args = <span class="branch-0 cbranch-no" title="branch not covered" >[])</span> {
