...
<html lang="en">
<head>
    <title>Code coverage report for lib/CompilerPass/index.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">lib/CompilerPass</a> index.js
    </h1>
    <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import PassConfig from '../PassConfig'
...
&nbsp;
  ...
  _getCompilerPassPriorityNumber (type, priority) {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (this[type][priority]) {
<span class="cstat-no" title="statement not covered" >      return this._getCompilerPassPriorityNumber(type, priority + 1)</span>
    }
&nbsp;
    return priority
  }
