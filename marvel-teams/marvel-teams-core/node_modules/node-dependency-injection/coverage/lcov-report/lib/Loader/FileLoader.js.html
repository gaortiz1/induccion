...
<html lang="en">
<head>
    <title>Code coverage report for lib/Loader/FileLoader.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">lib/Loader</a> FileLoader.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
  ...
  _parseDefinitions (services = []) {
    for (let id in services) {
      <span class="missing-if-branch" title="else path not taken" >E</span>if (services.hasOwnProperty(id)) {
...
&nbsp;
  ...
  _parseProperties (definition, properties = {}) {
    for (let propertyKey in properties) {
      <span class="missing-if-branch" title="else path not taken" >E</span>if (properties.hasOwnProperty(propertyKey)) {
...
&nbsp;
  ...
  _parseParameters (parameters = {}) {
    for (let key in parameters) {
      <span class="missing-if-branch" title="else path not taken" >E</span>if (parameters.hasOwnProperty(key)) {
