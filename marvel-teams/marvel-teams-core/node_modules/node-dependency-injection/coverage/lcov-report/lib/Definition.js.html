...
<html lang="en">
<head>
    <title>Code coverage report for lib/Definition.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">All files</a> / <a href="index.html">lib</a> Definition.js
    </h1>
    <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import MethodCallEmptyException from './Exception/MethodCallEmptyException'
...
&nbsp;
   ...
   * @return {boolean}
   */
  isPublic (bypassPublic = <span class="branch-0 cbranch-no" title="branch not covered" >false)</span> {
    return ((this.public) || (!bypassPublic &amp;&amp; <span class="branch-2 cbranch-no" title="branch not covered" >this.public)</span>)
  }
}
&nbsp;
