...
<html lang="en">
<head>
    <title>Code coverage report for lib/Compiler.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">All files</a> / <a href="index.html">lib</a> Compiler.js
    </h1>
    <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import ServiceCircularReferenceException from
  './Exception/ServiceCircularReferenceException'
...
&nbsp;
  run () {
    try {
      ...
      <span class="missing-if-branch" title="else path not taken" >E</span>if (error instanceof RangeError) {
...
&nbsp;
   ...
   */
  _loadExtensions () {
    for (let extension of this._container.extensions) {
      extension.load(this)
    }
  }
&nbsp;
