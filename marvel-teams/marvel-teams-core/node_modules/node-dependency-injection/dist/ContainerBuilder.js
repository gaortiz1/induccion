...
var _map = require('collections/map');
...
var ContainerBuilder = function () {
  function ContainerBuilder() {
    ...
    this._definitions = new _map2.default();
    this._parameters = new _map2.default();
    this._alias = new _map2.default();
    this._container = new _map2.default();
    this._frozen = false;
  ...
  _createClass(ContainerBuilder, [{
    ...
    value: function findTaggedServiceIds(name) {
      var taggedServices = new _map2.default();
