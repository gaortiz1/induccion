...
var FileLoader = function () {
  ...
  function FileLoader(container) {
    ...
    if (filePath) {
      this._container.logger.warn('DEPRECATED', 'The second argument in the FileLoader is deprecated. Please send the file path in the load method instead.');
  ...
  _createClass(FileLoader, [{
    ...
    value: function _checkFile(file) {
      if (!file) {
        this._container.logger.warn('DEPRECATED', 'The null argument in the load method is deprecated. ' + 'Please send the file path in this method instead of in the file load constructor');
      } else {
        this.filePath = file;
      }
    }
    ...
    value: function _requireClassNameFromPath(classObject) {
      var fromDirectory = _path2.default.dirname(this.filePath);
