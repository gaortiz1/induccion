...
var OptimizePass = function () {
  ...
  _createClass(OptimizePass, [{
    ...
    value: function _processDefinitionKeys(definitionId) {
      ...
      } else if (definition.decoratedService && !definitionId.includes(OptimizePass.POSTFIX_INNER)) {
    ...
    value: function _processDecorates(decorate) {
      this._container.setDefinition(decorate.name + '.' + OptimizePass.POSTFIX_INNER, this._container.definitions.get(decorate.definition.decoratedService));
